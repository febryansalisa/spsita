...
@section('title') Jadwal Sidang PAA @endsection
...
<a href="{{ route('sidang.create') }}" class="btn btn-primary">Buat Sidang</a>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $jadwalSidang->pengajuan_sidang->mahasiswa->nama }}</td>
