...
@section('title') Pengajuan Sidang Mahasiswa @endsection

@section('content')

<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Pengajuan Sidang</h1>
</div>

<form action="{{ route('pengajuan-sidang.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
